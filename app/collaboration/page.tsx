    ...
    const partnershipTiers = [
        {
            name: "Gold Partner",
            benefits: [
                "All benefits in Bronze tier and Silver tier",
                "20 Minute spotlight session",
                "Ability to create a special Challenge for participants",
                "Opportunity to provide 1 Judge to the hackathon (in space science, business or technical fields)",
        ...
        },
        {
            name: "Silver Partner",
            benefits: [
                "All benefits in Bronze tier",
                "Organization logo on all promotional posts",
                "Organization logo on all printable materials",
                "Organization logo displayed on the Local Event Page of the Global NASA Space Apps Challenge website",
                "Opportunity to provide 1-2 Mentors to the hackathon (in space science, business or technical fields)",
            ],
            color: "#9CA3AF",
        },
        {
